...
Free costs £0. Plus costs £3.99 per month and Pro costs £8.49 per month. Initial launch subscriptions are monthly only; no annual plan is offered unless TaxMate later introduces one with advance disclosure and agreement. TaxMate is not launching with a VAT-registered sales configuration: Stripe Tax is off, no VAT is added to these prices, and TaxMate does not issue a VAT amount or VAT invoice. Plus and Pro recur monthly when bought through Stripe Checkout. Before payment, Checkout must show the final price, monthly renewal arrangement, included plan and payment method. Paid access starts only after server-verified Stripe status; client settings cannot unlock it.</p>
...
Paid subscriptions renew monthly until cancelled. Use the Stripe billing portal from Settings or contact support to cancel. Unless Checkout or mandatory law says otherwise, cancellation stops future renewal and paid access continues until the end of the paid month. Cancelling a plan does not delete your records; use the separate deletion control if you want account data removed.</p>
