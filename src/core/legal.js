...
Free costs £0. Plus costs £3.99 per month and Pro costs £8.49 per month. Initial launch subscriptions are monthly only; no annual plan is offered unless TaxMate later introduces one with advance disclosure and agreement. Plus and Pro recur monthly when bought through Stripe Checkout. Before payment, Checkout must show the total price, taxes if applicable, monthly renewal arrangement, included plan and payment method. Paid access starts only after server-verified Stripe status; client settings cannot unlock it.</p>
