(function(root,factory){
  ...
  const api=factory(node?require('./money'):root.TaxMateMoney,node?require('./domain-schema'):root.TaxMateDomain,node?require('./partnership'):root.TaxMatePartnership,node?require('./company-profile'):root.TaxMateCompanyProfile,node?require('./company-profile-history'):root.TaxMateCompanyProfileHistory);
