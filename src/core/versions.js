(function attachVersions(root, factory) {
  ...
  const VERSIONS = Object.freeze({
    APP_VERSION: '2.1.13',
    BUILD_ID: '2026-09-01.account-isolation-backup-alias-favicon-production.1',
    STATE_SCHEMA_VERSION: 5,
    TAX_RULESET_VERSION: '2026-27.2026-08-17.1',
    FORM_MAPPING_VERSION: '2025-26.2026-04-06.1',
    SYNC_SCHEMA_VERSION: 5,
    PWA_CACHE_VERSION: 'taxmate-v2-account-isolation-backup-alias-favicon-production-1'
  });
  return { VERSIONS };
});
