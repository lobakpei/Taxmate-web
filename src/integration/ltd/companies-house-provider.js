...
const FOUNDER_PREVIEW_ALIAS='lobakpe1';
const FOUNDER_PREVIEW_MODE='ltd-founder-preview';
const FOUNDER_PREVIEW_COMPANY=Object.freeze({number:'00000000',name:'LOBAKPE FOUNDER PREVIEW LTD',incorporationDate:'2025-12-15',status:'active',type:'ltd',registryUrl:null});
...
function alias(value){return String(value||'').trim().toLowerCase()===FOUNDER_PREVIEW_ALIAS;}
function founderPreviewAllowed(context={}){return['localhost','127.0.0.1','::1','[::1]'].includes(String(context.hostname||'').toLowerCase())&&context.firebaseProjectId==='demo-taxmate'&&context.firebaseEmulators===true&&context.previewMode===FOUNDER_PREVIEW_MODE;}
...
return{PUBLIC_BASE_URL,SUPPORTED_TYPES,SUPPORTED_STATUSES,FOUNDER_PREVIEW_ALIAS,FOUNDER_PREVIEW_MODE,FOUNDER_PREVIEW_COMPANY,assessRegistryCompany,founderPreviewAllowed,unavailableProvider,createCallableProvider,createFounderPreviewProvider};
});
