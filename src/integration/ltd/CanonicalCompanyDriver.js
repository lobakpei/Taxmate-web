...
class CanonicalCompanyDriver{
  ...
  effectiveShareholders(profile=this.activeProfile()){if(!profile)return[];try{return CompanyProfileHistory.ownershipAtDate(profile,this.currentDate()).shareholders;}catch(_){return clone(profile.shareholders||[]);}}
