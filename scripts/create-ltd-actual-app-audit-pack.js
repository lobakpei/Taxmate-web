...
- Version: \`2.1.5\`
- Build: \`2026-08-29.founder-brand-sync-runtime-integrity.2\`
- Cache: \`taxmate-v2-founder-brand-sync-runtime-integrity-2\`
...
async function main(){
  ...
  try{
    ...
    write(path.join(payload,'review','IDENTITY.json'),JSON.stringify({...identity,version:'2.1.5',buildId:'2026-08-29.founder-brand-sync-runtime-integrity.2',cache:'taxmate-v2-founder-brand-sync-runtime-integrity-2',hosting},null,2)+'\n');
