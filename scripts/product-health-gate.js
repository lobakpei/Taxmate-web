...
assert.match(versions,/APP_VERSION:\s*'2\.1\.15'/);
assert.match(versions,/BUILD_ID:\s*'2026-09-02\.focused-repair-production\.1'/);
assert.match(versions,/PWA_CACHE_VERSION:\s*'taxmate-v2-focused-repair-production-1'/);
