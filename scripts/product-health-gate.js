...
assert.match(versions,/APP_VERSION:\s*'2\.1\.9'/);
assert.match(versions,/BUILD_ID:\s*'2026-08-31\.pro-checkout-enablement\.1'/);
assert.match(versions,/PWA_CACHE_VERSION:\s*'taxmate-v2-pro-checkout-enablement-1'/);
