...
assert.match(versions,/APP_VERSION:\s*'2\.1\.14'/);
assert.match(versions,/BUILD_ID:\s*'2026-09-02\.first-sync-safety-production\.2'/);
assert.match(versions,/PWA_CACHE_VERSION:\s*'taxmate-v2-first-sync-safety-production-2'/);
