...
assert.match(versions,/APP_VERSION:\s*'2\.1\.17'/);
assert.match(versions,/BUILD_ID:\s*'2026-09-03\.backup-auth-hotfix-production\.1'/);
assert.match(versions,/PWA_CACHE_VERSION:\s*'taxmate-v2-backup-auth-hotfix-production-1'/);
