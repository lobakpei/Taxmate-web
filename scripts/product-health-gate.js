...
assert.match(versions,/APP_VERSION:\s*'2\.1\.18'/);
assert.match(versions,/BUILD_ID:\s*'2026-09-03\.ltd-focused-hotfix-candidate\.1'/);
assert.match(versions,/PWA_CACHE_VERSION:\s*'taxmate-v2-ltd-focused-hotfix-candidate-1'/);
