...
assert.match(versions,/BUILD_ID:\s*'2026-09-01\.full-backup-founder-alias-preview\.1'/);
assert.match(versions,/PWA_CACHE_VERSION:\s*'taxmate-v2-full-backup-founder-alias-preview-1'/);
