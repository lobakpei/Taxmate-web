...
async function rasterOpticalIcon(page,svg,size,output,maskable=false){
  ...
  const targetWidth=size<=48?0.87:0.80,targetCenterX=size<=48?0.50:0.535,targetCenterY=size<=48?0.50:0.505,scale=maskable?Math.min(0.63/baseWidth,0.63/baseHeight):targetWidth/baseWidth,left=((maskable?0.5:targetCenterX)-sourceCenterX*scale)*size,top=((maskable?0.5:targetCenterY)-sourceCenterY*scale)*size;
