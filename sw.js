...
const CACHE = 'taxmate-v2-preview-3';
const CACHE_PREFIX = 'taxmate-';
const SHELL = ['/', '/index.html', '/manifest.json', '/icon-192.png', '/icon-512.png', '/icon-512-maskable.png',
  '/src/core/versions.js','/src/core/tax-rules.js','/src/core/tax-engine.js','/src/core/mtd.js','/src/core/form-mappings.js','/src/core/state-schema.js','/src/core/portable-backup.js','/src/core/sync.js','/src/core/entitlement.js','/src/core/telemetry.js',
