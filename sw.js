...
const CACHE = 'taxmate-v2-partner-invite-share-identity-founder-preview-1';
const SHELL = ['/', '/index.html', '/help.html', '/privacy.html', '/terms.html', '/manifest.json', '/favicon.ico', '/favicon-16x16.png', '/favicon-32x32.png', '/favicon-48x48.png', '/apple-touch-icon.png', '/icon-192.png', '/icon-512.png', '/icon-512-maskable.png', '/taxmate-share-20260829.png', '/assets/brand/derived/taxmate-brand-logo-light.svg', '/assets/brand/derived/taxmate-brand-logo-dark.svg', '/assets/brand/derived/taxmate-icon-light.svg', '/assets/brand/derived/taxmate-icon-dark.svg',
