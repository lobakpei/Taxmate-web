...
const CACHE = 'taxmate-v2-build21-ui-acceptance-20260921-2';
const SHELL = ['/', '/index.html', '/help.html', '/privacy.html', '/delete-account.html', '/terms.html', '/manifest.json?v=20260905-1', '/favicon.ico', '/favicon-16x16.png?v=20260903-8', '/favicon-32x32.png?v=20260903-8', '/favicon-48x48.png?v=20260903-8', '/apple-touch-icon.png?v=20260903-8', '/icon-192.png?v=20260903-10', '/icon-512.png?v=20260903-10', '/icon-512-maskable.png?v=20260903-10', '/taxmate-share-20260831-v2.png', '/assets/brand/derived/taxmate-brand-logo-light.svg', '/assets/brand/derived/taxmate-brand-logo-dark.svg', '/assets/brand/derived/taxmate-icon-light.svg', '/assets/brand/derived/taxmate-icon-dark.svg',
  '/src/app/billing-copy.js','/src/app/billing-ui.js','/src/app/help.js',
  '/src/core/company-statutory.js',
  '/src/core/versions.js','/src/core/tax-rules.js','/src/core/tax-engine.js','/src/core/mtd.js','/src/core/form-mappings.js','/src/core/money.js','/src/core/partnership.js','/src/core/partner-invite.js','/src/core/state-schema.js','/src/core/account-storage.js','/src/core/foreground-ui.js','/src/core/retention-policy.js','/src/core/local-receipts.js','/src/core/backup-transfer.js','/src/core/assistant.js','/src/core/domain-schema.js','/src/core/company-profile.js','/src/core/company-identity.js','/src/core/company-tax-rules.js','/src/core/company-profile-history.js','/src/core/company-treatment.js','/src/core/company-ledger.js','/src/core/company-remuneration-rules.js','/src/core/company-remuneration.js','/src/core/company-scenario.js','/src/core/company-tax.js','/src/core/company-deadlines.js','/src/core/company-workspace.js','/src/core/domain-migration.js','/src/integration/ltd/company-state.js','/src/integration/ltd/company-state-repository.js','/src/integration/ltd/company-structural-state.js','/src/integration/ltd/company-transaction-adapter.js','/src/integration/ltd/companies-house-provider.js','/src/integration/ltd/CanonicalCompanyDriver.js','/src/integration/ltd/TaxMateLtdUIFacade.js','/src/integration/ltd/TaxMateLtdProductionAdapter.js','/src/integration/ltd/approved-copy.json','/src/ui/ltd/workbench-renderer.js','/src/ui/ltd/workbench.css','/src/core/revision-sync.js','/src/core/ltd-sync.js','/src/core/company-evidence.js','/src/core/portable-backup.js','/src/core/onboarding-root.js','/src/core/sync.js','/src/core/entitlement.js','/src/core/company-access.js','/src/core/telemetry.js','/src/core/product-content.js',
  '/src/core/company-books.js','/src/core/backup-export.js','/src/core/pwa-install.js','/src/core/auth-flow.js','/firebase-environment.js','/src/app/bootstrap.js','/src/app/sentry-bootstrap.js','/src/app/action-dispatch.js','/src/app/app.js','/src/app/audit.js','/src/ui/direction-a.css','/assets/fonts/plus-jakarta-sans-latin-500-800.woff2','/assets/fonts/plus-jakarta-sans-OFL.txt','/vendor/jszip-3.10.1.min.js'];
  ...
  e.waitUntil((async () => {
    try {
      ...
      for (const u of SHELL) {
        ...
        if (!response || !response.ok || (!['/', '/index.html', '/help.html', '/privacy.html', '/delete-account.html', '/terms.html'].includes(u) && type.includes('text/html'))) throw new Error('invalid-essential-runtime-response');
      }
  ...
  e.respondWith((async () => {
    ...
    if (essentialPath) {
      ...
      try {
        ...
        if (!res.ok || (!['/', '/index.html', '/help.html', '/privacy.html', '/delete-account.html', '/terms.html'].includes(url.pathname) && type.includes('text/html'))) return Response.error();
