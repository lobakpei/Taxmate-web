...
async function main(){
  ...
  const result={status:'PASS',assertions:assertionCount,version:'2.1.11',build:'2026-09-01.full-backup-founder-alias-preview.1',cache:'taxmate-v2-full-backup-founder-alias-preview-1',externalRequests,sentryRequests,checks:assertions};
