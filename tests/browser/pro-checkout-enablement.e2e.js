...
async function main(){
  ...
  const result={status:'PASS',assertions:assertionCount,version:'2.1.14',build:'2026-09-02.first-sync-safety-production.2',cache:'taxmate-v2-first-sync-safety-production-2',externalRequests,sentryRequests,checks:assertions};
