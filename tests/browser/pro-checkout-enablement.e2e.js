...
async function main(){
  ...
  const result={status:'PASS',assertions:assertionCount,version:'2.1.9',build:'2026-08-31.pro-checkout-enablement.1',cache:'taxmate-v2-pro-checkout-enablement-1',externalRequests,sentryRequests,checks:assertions};
