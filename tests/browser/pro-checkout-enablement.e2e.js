...
async function main(){
  ...
  const result={status:'PASS',assertions:assertionCount,version:'2.1.11',build:'2026-08-31.partner-invite-share-identity-founder-preview.1',cache:'taxmate-v2-partner-invite-share-identity-founder-preview-1',externalRequests,sentryRequests,checks:assertions};
