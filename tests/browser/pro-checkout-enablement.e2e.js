...
async function main(){
  ...
  const result={status:'PASS',assertions:assertionCount,version:'2.1.10',build:'2026-08-31.partnership-personal-share-founder-preview.1',cache:'taxmate-v2-partnership-personal-share-founder-preview-1',externalRequests,sentryRequests,checks:assertions};
