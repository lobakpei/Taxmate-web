...
async function main(){
  ...
  const result={status:'PASS',assertions:assertionCount,version:'2.1.15',build:'2026-09-02.focused-repair-production.1',cache:'taxmate-v2-focused-repair-production-1',externalRequests,sentryRequests,checks:assertions};
