...
async function main(){
  ...
  assert.equal(receiptHeader.paddingBottom,'14px','Add receipts uses the standard compact app caption height');
  assert.equal(receiptHeader.borderBottomLeftRadius,'22px','Add receipts uses the standard app caption corner radius');
