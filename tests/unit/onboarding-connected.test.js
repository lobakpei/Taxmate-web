...
test('review identity is coherent and production schemas/providers stay outside the change contract',()=>{
  ...
  assert.deepEqual({version:versions.APP_VERSION,build:versions.BUILD_ID,cache:versions.PWA_CACHE_VERSION},{version:'2.1.26',build:'2026-09-09.backup-diagnostic.1',cache:'taxmate-v2-backup-diagnostic-20260909-1'});
