...
test('review identity is coherent and production schemas/providers stay outside the change contract',()=>{
  ...
  assert.deepEqual({version:versions.APP_VERSION,build:versions.BUILD_ID,cache:versions.PWA_CACHE_VERSION},{version:'2.1.19',build:'2026-09-03.founder-production-hotfix-candidate.1',cache:'taxmate-v2-founder-production-hotfix-candidate-1'});
