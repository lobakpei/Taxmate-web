...
Staging-only: signed-in receipt enumeration/upload/restore, Google Auth, Firebase/App Check, GA4 delivery, Sentry ingestion and Stripe entry points. Apple Sign-In is intentionally removed. These integrations were not faked and must be checked against isolated non-production credentials before release.
