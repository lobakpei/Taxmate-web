...
| Personal Firestore tree | Active account lifetime | Server recursive delete before Auth deletion | Emulator integration proof passed; external provider backup/log lifecycle remains |
...
| Receipt objects | Active account/entry lifetime | Individual delete or server prefix delete; failures now prevent a success claim | Storage/Functions emulator deletion passed; soft-delete was observed as seven days in W0 and must be reconfirmed in staging |
