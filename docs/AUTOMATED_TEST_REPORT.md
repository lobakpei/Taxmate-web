...
Closeout date: 20 August 2026. Build: `2026-08-20.billing-promo-rc.10`.
...
RC.10 adds fixed-window and permanent Founder promotion validation, start/expiry/cap enforcement, concurrent-final-slot protection, paid/promotion tier priority, exact notification lifecycle, permanent-Pro checkout protection, Founder admin operations and canonical LIVE-price environment separation. The current Functions Emulator delta passed 5/5; the prior RC.9 correct-account hosted Sandbox receipts remain frozen and were not recreated. The current browser audit passed 29/29 with zero fail/warn.
