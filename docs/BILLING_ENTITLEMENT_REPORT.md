...
Completed in TEST: a real hosted Pro Checkout charged exactly £8.49 with tax 0, its real completion event projected backend Pro entitlement, and the payment was fully refunded and subscription cancelled. Checkout explicitly disables Stripe Tax. Full refunds immediately end the refunded paid entitlement with active-promotion fallback; partial refunds preserve entitlement and enter manual review. Candidate Functions remain undeployed because the isolated staging project requires Founder-authorised Blaze billing. No Stripe LIVE object or payment was created.
