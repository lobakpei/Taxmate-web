...
No TaxMate Stripe secret, price object, webhook or Function was configured or deployed in this programme. The only authenticated TEST sandbox belongs to another product and was inspected read-only. Paid buttons therefore fail safely in the local Founder Preview and do not change access. Deployment requires a TaxMate TEST sandbox with Price objects matching £3.99/month Plus and £8.49/month Pro, a valid Terms URL, VAT/tax confirmation, durable confirmation, cancellation/cooling-off review, secret injection, webhook registration and sandbox acceptance before any live release. Refund-to-entitlement behavior remains a Founder commercial decision and is not invented by the client.
