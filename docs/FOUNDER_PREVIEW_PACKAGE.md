...
Runtime identity is app `2.0.0-rc.1`, build `2026-08-20.google-only-auth-recovery-rc.11`, state/sync schema 5, tax rules `2026-27.2026-08-17.1`, form map `2025-26.2026-04-06.1` and PWA cache `taxmate-v2-rc-1-google-only-auth-recovery-rc-11`.
...
Run `node scripts/preview-server.js`, then open `http://127.0.0.1:4173/?auth-recovery=rc11`. Exact final commit/tree and regression totals are supplied in the Founder handoff.
