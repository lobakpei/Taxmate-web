...
| Remaining blocker | APPROVAL | Explicit Founder production-release approval; the approved deployment must then verify Functions secret binding before paid checkout is accepted. |
