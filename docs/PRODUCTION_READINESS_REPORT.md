...
| 4 | Build ID | PASS | `2026-08-19.external-services-rc.2` |
...
| 31 | Full test totals | PASS | Repository gate 94/94 plus external Stripe sandbox integration 1/1 |
| 32 | Known limitations | PASS | `KNOWN_LIMITATIONS.md` updated |
| 33 | Remaining blockers | BLOCKED | ICO propagation; undeployed Firebase Functions; cloud/telemetry access; Founder VAT/refund decisions |
| 34 | Rollback plan | PASS | `ROLLBACK.md` updated; production remains unchanged |
| 35 | Final preview URL | PASS | `http://127.0.0.1:4173/?external-services-rc=2` |
...
5. Correct GA4 property/DebugView and Sentry project access, plus action-time approval for minimal test telemetry.
